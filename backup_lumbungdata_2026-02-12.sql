...
INSERT INTO `desa` VALUES (1,'0001','Desa Lumbung','Kecamatan Lumbung','Kabupaten Lumbung','Jawa Barat',NULL,NULL,0,0,'swadaya',NULL,NULL,NULL,NULL,NULL,'2026-02-12 07:44:37','2026-02-12 07:44:37');
...
CREATE TABLE `dinas_luar` (
  ...
  `instasi_tujuan` text COLLATE utf8mb4_unicode_ci,
  `surat_tugas` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keterangan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `dinas_luar_id_pegawai_foreign` (`id_pegawai`),
  CONSTRAINT `dinas_luar_id_pegawai_foreign` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hari_libur` (
  ...
  `nama_libur` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis` enum('nasional','cuti_bersama','khusus') COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `jenis_kehadiran`
--

DROP TABLE IF EXISTS `jenis_kehadiran`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `jenis_kehadiran` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kode_kehadiran` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_kehadiran` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `jenis_kehadiran_kode_kehadiran_unique` (`kode_kehadiran`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jenis_kehadiran`
--

LOCK TABLES `jenis_kehadiran` WRITE;
/*!40000 ALTER TABLE `jenis_kehadiran` DISABLE KEYS */;
/*!40000 ALTER TABLE `jenis_kehadiran` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `kehadiran_bulanan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kehadiran_bulanan` (
  ...
  `jumlah_dinas_luar` int NOT NULL DEFAULT '0',
  `total_hari_kerja` int NOT NULL DEFAULT '0',
  `presentase_kehadiran` decimal(5,2) NOT NULL DEFAULT '0.00',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `kehadiran_bulanan_id_pegawai_foreign` (`id_pegawai`),
  CONSTRAINT `kehadiran_bulanan_id_pegawai_foreign` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kehadiran_bulanan`
--

LOCK TABLES `kehadiran_bulanan` WRITE;
/*!40000 ALTER TABLE `kehadiran_bulanan` DISABLE KEYS */;
/*!40000 ALTER TABLE `kehadiran_bulanan` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `kehadiran_harian`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kehadiran_harian` (
  ...
  `id_jenis_kehadiran` bigint unsigned NOT NULL,
  `lokasi_absen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metode_absen` enum('manual','fingerprint','qr') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `keterangan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `kehadiran_harian_id_pegawai_foreign` (`id_pegawai`),
  KEY `kehadiran_harian_id_jenis_kehadiran_foreign` (`id_jenis_kehadiran`),
  CONSTRAINT `kehadiran_harian_id_jenis_kehadiran_foreign` FOREIGN KEY (`id_jenis_kehadiran`) REFERENCES `jenis_kehadiran` (`id`) ON DELETE CASCADE,
  CONSTRAINT `kehadiran_harian_id_pegawai_foreign` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `kehadiran_harian` WRITE;
/*!40000 ALTER TABLE `kehadiran_harian` DISABLE KEYS */;
/*!40000 ALTER TABLE `kehadiran_harian` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kehadiran_tahunan`
--

DROP TABLE IF EXISTS `kehadiran_tahunan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kehadiran_tahunan` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_pegawai` bigint unsigned NOT NULL,
  `tahun` year NOT NULL,
  `total_hari_kerja` int NOT NULL DEFAULT '0',
  `total_hadir` int NOT NULL DEFAULT '0',
  `total_tidak_hadir` int NOT NULL DEFAULT '0',
  `presentase_kehadiran` decimal(5,2) NOT NULL DEFAULT '0.00',
  `catatan_evaluasi` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `kehadiran_tahunan_id_pegawai_foreign` (`id_pegawai`),
  CONSTRAINT `kehadiran_tahunan_id_pegawai_foreign` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kehadiran_tahunan`
--

LOCK TABLES `kehadiran_tahunan` WRITE;
/*!40000 ALTER TABLE `kehadiran_tahunan` DISABLE KEYS */;
/*!40000 ALTER TABLE `kehadiran_tahunan` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `keterangan` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_pegawai` bigint unsigned NOT NULL,
  `jenis_absensi` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pejabar_penyetuju` text COLLATE utf8mb4_unicode_ci,
  `keterangan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `keterangan_id_pegawai_foreign` (`id_pegawai`),
  CONSTRAINT `keterangan_id_pegawai_foreign` FOREIGN KEY (`id_pegawai`) REFERENCES `pegawai` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pegawai` (
  ...
  `status_kepegawaian` enum('PNS','honorer','perangkat desa') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'perangkat desa',
  `alamat` text COLLATE utf8mb4_unicode_ci,
  `nomor_telepon` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_aktif` enum('aktif','tidak aktif') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aktif',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `sessions` VALUES ('WDbkleIZgeb3lV1BKQYITo1CAOYpqi79C6TnjMOS',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36','',1770907742);
...
INSERT INTO `users` VALUES (1,'Ramdan Dwi Saputra','Ramdan Dwi Saputra','ramdan@gmail.com',NULL,'$2y$12$.SarkDlQ86XAaXXjIPY7CuN7IGhZvyJjxXyiueLXtQYTLnulr8KRC',NULL,'admin','2026-02-12 07:44:36','2026-02-12 07:44:36'),(2,'Ramdan','ramdan','ramdan@gmail.com',NULL,'$2y$12$XYgKGQpDBuFqYeic8bDP1.gSBsqUUeWtnoLM9009qKto1HlY8xY8O',NULL,'admin','2026-02-12 07:44:37','2026-02-12 07:44:37');
...
INSERT INTO `wilayah` VALUES (1,1,'Dusun 1','001','001','Ketua RT 1','Ketua RW 1',10,50,0,0,'2026-02-12 07:44:37','2026-02-12 07:44:37');
...
-- Dump completed on 2026-02-12 22:03:28
