...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold gradient-text">Tambah Artikel</h1>
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="p-4 bg-gray-50 rounded-lg">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-green-700">Akan dipublikasikan</span>
                                @else
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <!-- Image Preview -->
                        <div class="mb-4">
                            <div class="w-full h-48 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden">
                                <div class="text-center">
                                    <svg class="w-12 h-12 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                    <p class="text-sm text-gray-500">Pilih gambar untuk artikel</p>
                                </div>
                            </div>
                        </div>
