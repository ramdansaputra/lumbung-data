        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
            <div class="animate-fade-in">
                ...
                <div class="flex items-center gap-2 text-sm text-slate-500 mt-2">
                    ...
                    <span>Beranda</span>
                    <span>/</span>
                    <span class="text-slate-700 font-medium">Info Desa</span>
                    <span>/</span>
                    <span class="text-slate-700 font-medium">Wilayah Administratif</span>
                    <span>/</span>
                    <span class="text-slate-700 font-medium">Edit Dusun</span>
                </div>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('admin.info-desa.wilayah-administratif.update', $wilayah['id']) }}">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="number" name="rw" id="rw" value="{{ old('rw', $wilayah['rw']) }}" min="1" required
                                   class="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200">
                            @error('rw')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="rt" id="rt" value="{{ old('rt', $wilayah['rt']) }}" min="1" required
                                   class="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200">
                            @error('rt')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="kk" id="kk" value="{{ old('kk', $wilayah['kk']) }}" min="0" required
                               class="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200">
                        @error('kk')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <div>
                            ...
                            <input type="number" name="laki_laki" id="laki_laki" value="{{ old('laki_laki', $wilayah['laki_laki']) }}" min="0" required
                                   class="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200">
                            @error('laki_laki')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="perempuan" id="perempuan" value="{{ old('perempuan', $wilayah['perempuan']) }}" min="0" required
                                   class="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200">
                            @error('perempuan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
