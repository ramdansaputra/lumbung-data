...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-emerald-50 p-6">
    <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="relative px-8 py-8 bg-gradient-to-br from-amber-600 via-orange-600 to-rose-500">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-1.5 tracking-tight">Edit Data Dinas Luar</h1>
                            <p class="text-orange-100 text-sm font-medium">Perbarui informasi dinas luar {{
                                $dinasLuar->nama_kegiatan }}</p>
                        </div>
                    </div>
        ...
        <!-- Form Section -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden">
            <form action="{{ route('admin.dinas-luar.update', $dinasLuar->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select
                                    ...
                                    <option value="{{ $p->id }}" {{ old('id_pegawai', $dinasLuar->id_pegawai) == $p->id
                                        ? 'selected' : '' }}>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('tanggal_selesai', $dinasLuar->tanggal_selesai) }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    id="instasi_tujuan" name="instasi_tujuan"
                                    value="{{ old('instasi_tujuan', $dinasLuar->instasi_tujuan) }}">
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    id="surat_tugas" name="surat_tugas"
                                    value="{{ old('surat_tugas', $dinasLuar->surat_tugas) }}">
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <textarea
                                    ...
                                    rows="4">{{ old('keterangan', $dinasLuar->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
