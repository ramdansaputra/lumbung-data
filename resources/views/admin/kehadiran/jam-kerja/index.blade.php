            ...
            <div class="relative px-8 py-8 bg-gradient-to-br from-emerald-600 via-teal-600 to-teal-500">
                ...
                <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-1.5 tracking-tight">Data Jam Kerja</h1>
                            <p class="text-teal-100 text-sm font-medium">Kelola jadwal jam kerja pegawai dengan sistem
                                modern
                            </p>
                        </div>
                    </div>
                    <a href="{{ route('admin.jam-kerja.create') }}"
                        ...
                        <span class="relative">Tambah Jam Kerja</span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-8 py-8 bg-gradient-to-br from-slate-50/50 to-white/50">
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Total Jadwal</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $jamKerja->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Aktif Hari Ini</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $jamKerja->where('hari',
                                now()->format('l'))->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Rata-rata Toleransi</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $jamKerja->avg('toleransi_terlambat') ?
                                round($jamKerja->avg('toleransi_terlambat')) : 0 }} min</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="relative group/avatar">
                                        ...
                                        <div
                                            ...
                                            {{ strtoupper(substr($item->hari, 0, 2)) }}
                                        </div>
                                    </div>
                                    <span class="text-sm font-semibold text-slate-900">{{ $item->hari }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-gradient-to-r from-teal-100 to-teal-100 text-teal-700 border border-teal-200/50 shadow-sm">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                                            clip-rule="evenodd" />
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span class="text-sm text-slate-700 font-medium">{{ $item->toleransi_terlambat }}
                                    menit</span>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.jam-kerja.edit', $item->id) }}"
                                    ...
                                    <form action="{{ route('admin.jam-kerja.destroy', $item->id) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            ...
                                            onclick="return confirm('Yakin ingin menghapus jam kerja ini?')">
                                            <div
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-xl font-bold text-slate-900 mb-2">Belum Ada Data Jam Kerja</h3>
                                    <p class="text-sm text-slate-500 mb-8 max-w-md">Mulai tambahkan jadwal jam kerja
                                        untuk mengatur waktu kerja pegawai</p>
                                    <a href="{{ route('admin.jam-kerja.create') }}"
                                        ...
                                        <span class="relative">Tambah Jam Kerja Pertama</span>
                                    </a>
                                </div>
                            </td>
                        </tr>
