...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-emerald-50 p-6">
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <!-- Form Section -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden">
            <form action="{{ route('admin.keterangan.store') }}" method="POST" class="p-8">
                @csrf
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select
                                    ...
                                    <option value="disetujui" {{ old('status_persetujuan')=='disetujui' ? 'selected'
                                        : '' }}>Disetujui</option>
                                    <option value="ditolak" {{ old('status_persetujuan')=='ditolak' ? 'selected' : ''
                                        }}>Ditolak</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                    <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <textarea
                                    ...
                                    placeholder="Jelaskan alasan keterangan absensi...">{{ old('alasan') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    id="surat_pendukung" name="surat_pendukung" value="{{ old('surat_pendukung') }}"
                                    placeholder="Nomor surat pendukung">
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('pejabar_penyetuju') }}" placeholder="Nama pejabat yang menyetujui">
                            </div>
                        </div>
