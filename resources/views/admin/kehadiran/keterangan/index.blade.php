            ...
            <div class="relative px-8 py-8 bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500">
                ...
                <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-1.5 tracking-tight">Data Keterangan</h1>
                            <p class="text-blue-100 text-sm font-medium">Kelola keterangan absensi pegawai dengan sistem modern
                            </p>
                        </div>
                    </div>
                    <a href="{{ route('admin.keterangan.create') }}"
                        ...
                        <span class="relative">Tambah Keterangan</span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-8 py-8 bg-gradient-to-br from-slate-50/50 to-white/50">
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Total Keterangan</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $keterangan->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Pending</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $keterangan->where('status_persetujuan',
                                'pending')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm text-slate-600 font-semibold mb-1">Disetujui</p>
                            <p class="text-3xl font-bold text-slate-900">{{ $keterangan->where('status_persetujuan',
                                'disetujui')->count() }}</p>
                        </div>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($keterangan as $index => $item)
                        <tr
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span class="text-sm text-slate-700">{{ $item->jenis_absensi }}</span>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span class="text-sm text-slate-700">{{ \Carbon\Carbon::parse($item->tanggal_mulai)->format('d/m/Y') }}</span>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.keterangan.show', $item->id) }}"
                                        class="group/btn relative inline-flex items-center gap-1.5 px-3.5 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-xs font-bold rounded-lg shadow-md hover:shadow-xl transition-all duration-200 hover:scale-105 overflow-hidden">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-r from-indigo-700 to-blue-700 opacity-0 group-hover/btn:opacity-100 transition-opacity">
                                        </div>
                                    ...
                                    <a href="{{ route('admin.keterangan.edit', $item->id) }}"
                                    ...
                                    <form action="{{ route('admin.keterangan.destroy', $item->id) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-xl font-bold text-slate-900 mb-2">Belum Ada Data Keterangan</h3>
                                    <p class="text-sm text-slate-500 mb-8 max-w-md">Mulai tambahkan data keterangan untuk
                                    ...
                                    <a href="{{ route('admin.keterangan.create') }}"
                                        ...
                                        <span class="relative">Tambah Keterangan Pertama</span>
                                    </a>
                                </div>
                            </td>
                        </tr>
