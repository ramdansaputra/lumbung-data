                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100 text-sm font-medium">Lengkapi formulir untuk menambahkan pegawai
                                baru</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 font-medium @error('nik') border-rose-500 ring-4 ring-rose-500/20 @enderror"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 font-medium @error('nip') border-rose-500 ring-4 ring-rose-500/20 @enderror"
                        ...
                        <div class="md:col-span-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 font-medium @error('nama_lengkap') border-rose-500 ring-4 ring-rose-500/20 @enderror"
