...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-emerald-50 p-6">
    <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="relative px-8 py-8 bg-gradient-to-br from-amber-600 via-orange-600 to-rose-500">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-1.5 tracking-tight">Edit Data Pegawai</h1>
                            <p class="text-orange-100 text-sm font-medium">Perbarui informasi pegawai {{
        ...
        <!-- Form Section -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden">
            <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 transition-all duration-200 font-medium @error('nik') border-rose-500 ring-4 ring-rose-500/20 @enderror"
                                    id="nik" name="nik" value="{{ old('nik', $pegawai->nik) }}" maxlength="16" required>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 transition-all duration-200 font-medium @error('nip') border-rose-500 ring-4 ring-rose-500/20 @enderror"
                                    id="nip" name="nip" value="{{ old('nip', $pegawai->nip) }}" maxlength="18">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-amber-500/20 focus:border-amber-500 transition-all duration-200 font-medium @error('nama_lengkap') border-rose-500 ring-4 ring-rose-500/20 @enderror"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select
                                    ...
                                    <option value="PNS" {{ old('status_kepegawaian', $pegawai->status_kepegawaian) ==
                                        'PNS' ? 'selected' : '' }}>PNS</option>
                                    <option value="honorer" {{ old('status_kepegawaian', $pegawai->status_kepegawaian)
                                        == 'honorer' ? 'selected' : '' }}>Honorer</option>
                                    <option value="perangkat desa" {{ old('status_kepegawaian', $pegawai->
                                        status_kepegawaian) == 'perangkat desa' ? 'selected' : '' }}>Perangkat Desa
                                    </option>
                                </select>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select
                                    ...
                                    <option value="aktif" {{ old('status_aktif', $pegawai->status_aktif) == 'aktif' ?
                                        'selected' : '' }}>Aktif</option>
                                    <option value="tidak aktif" {{ old('status_aktif', $pegawai->status_aktif) == 'tidak
                                        aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                    <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nomor_telepon', $pegawai->nomor_telepon) }}" maxlength="15">
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <textarea
                                    ...
                                    id="alamat" name="alamat" rows="4">{{ old('alamat', $pegawai->alamat) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
