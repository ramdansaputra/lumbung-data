...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Data Keluarga Baru</h3>
            <p class="text-sm text-gray-500 mt-1">Lengkapi formulir di bawah ini untuk menambahkan keluarga baru</p>
        </div>

        <form action="{{ route('admin.keluarga.store') }}" method="POST" class="p-6">
            @csrf
...
@push('scripts')
<script>
    // Auto-format No KK input (numbers only, max 16 digits)
