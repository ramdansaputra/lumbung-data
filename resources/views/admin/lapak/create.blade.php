...
<div>
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span class="text-gray-700 font-medium">Tambah Lapak</span>
    </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <p class="text-xs text-gray-400 text-center">JPG, PNG, WEBP. Maksimal 2MB</p>
                        @error('foto')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_toko" value="{{ old('nama_toko') }}"
                                placeholder="Contoh: Toko Sembako Bu Sari" class="w-full px-3.5 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="3" placeholder="Ceritakan tentang lapak ini..."
                        ...
                        <div>
                            ...
                            <textarea name="alamat" rows="2" placeholder="Alamat lengkap lapak"
                                class="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none">{{ old('alamat') }}</textarea>
                        </div>
