...
<div>
    ...
    <form action="{{ route('admin.lapak.produk.store', $lapak) }}" method="POST" enctype="multipart/form-data"
        x-data="{ previewUrl: '{{ asset('images/no-image.png') }}' }">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_produk" value="{{ old('nama_produk') }}"
                                placeholder="Contoh: Beras Premium 5kg" class="w-full px-3.5 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="3" placeholder="Deskripsi produk..."
                                class="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none">{{ old('deskripsi') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga" value="{{ old('harga', 0) }}" min="0" step="100"
                                        class="w-full pl-9 pr-3 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent
                            ...
                            <div>
                                ...
                                <input type="number" name="stok" value="{{ old('stok', 0) }}" min="0" class="w-full px-3.5 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent
                            ...
                            <div>
                                ...
                                <select name="satuan"
                                    ...
                                    as $sat)
                                    <option value="{{ $sat }}" {{ old('satuan')==$sat ? 'selected' : '' }}>{{ $sat }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
