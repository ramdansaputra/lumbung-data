...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Edit Data Penduduk</h3>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi untuk <span class="font-medium text-gray-900">{{
                    $penduduk->nama }}</span></p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="golongan_darah" name="golongan_darah"
                            ...
                            <option value="A" {{ old('golongan_darah', $penduduk->golongan_darah) == 'A' ? 'selected' :
                                '' }}>A</option>
                            <option value="B" {{ old('golongan_darah', $penduduk->golongan_darah) == 'B' ? 'selected' :
                                '' }}>B</option>
                            <option value="AB" {{ old('golongan_darah', $penduduk->golongan_darah) == 'AB' ? 'selected'
                                : '' }}>AB</option>
                            <option value="O" {{ old('golongan_darah', $penduduk->golongan_darah) == 'O' ? 'selected' :
                                '' }}>O</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="agama" name="agama"
                            ...
                            <option value="Budha" {{ old('agama', $penduduk->agama) == 'Budha' ? 'selected' : ''
                                }}>Budha</option>
                    ...
                    <div>
                        ...
                        <select id="kewarganegaraan" name="kewarganegaraan"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="WNI" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 'WNI' ?
                                'selected' : '' }}>WNI</option>
                            <option value="WNA" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 'WNA' ?
                                'selected' : '' }}>WNA</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="hubungan_keluarga" name="hubungan_keluarga"
                            ...
                            <option value="kepala_keluarga" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'kepala_keluarga' ? 'selected' : '' }}>Kepala Keluarga</option>
                            <option value="istri" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'istri' ? 'selected' : '' }}>Istri</option>
                            <option value="anak" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'anak' ? 'selected' : '' }}>Anak</option>
                            <option value="orang_tua" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'orang_tua' ? 'selected' : '' }}>Orang Tua</option>
                            <option value="saudara" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'saudara' ? 'selected' : '' }}>Saudara</option>
                            <option value="lainnya" {{ old('hubungan_keluarga', $currentKeluarga?->pivot?->hubungan_keluarga) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="hubungan_rumah_tangga" name="hubungan_rumah_tangga"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="">Pilih hubungan (opsional)</option>
                            <option value="kepala_rumah_tangga" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'kepala_rumah_tangga' ? 'selected' : '' }}>Kepala Rumah Tangga</option>
                            <option value="istri" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'istri' ? 'selected' : '' }}>Istri</option>
                            <option value="anak" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'anak' ? 'selected' : '' }}>Anak</option>
                            <option value="orang_tua" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'orang_tua' ? 'selected' : '' }}>Orang Tua</option>
                            <option value="saudara" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'saudara' ? 'selected' : '' }}>Saudara</option>
                            <option value="lainnya" {{ old('hubungan_rumah_tangga', $currentRumahTangga?->pivot?->hubungan_rumah_tangga) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="status_hidup" name="status_hidup"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="hidup" {{ old('status_hidup', $penduduk->status_hidup) == 'hidup' ?
                                'selected' : '' }}>Hidup</option>
                            <option value="meninggal" {{ old('status_hidup', $penduduk->status_hidup) == 'meninggal' ?
                    ...
                    <div>
                        ...
                        <select id="status_kawin" name="status_kawin"
                            ...
                            <option value="Belum Kawin" {{ old('status_kawin', $penduduk->status_kawin) == 'Belum Kawin'
                                ? 'selected' : '' }}>Belum Kawin</option>
                            <option value="Kawin" {{ old('status_kawin', $penduduk->status_kawin) == 'Kawin' ?
                                'selected' : '' }}>Kawin</option>
                            <option value="Cerai Hidup" {{ old('status_kawin', $penduduk->status_kawin) == 'Cerai Hidup'
                                ? 'selected' : '' }}>Cerai Hidup</option>
                            <option value="Cerai Mati" {{ old('status_kawin', $penduduk->status_kawin) == 'Cerai Mati' ?
                    ...
                    <div>
                        ...
                        <select id="pendidikan" name="pendidikan"
                            ...
                            <option value="Tidak Sekolah" {{ old('pendidikan', $penduduk->pendidikan) == 'Tidak Sekolah'
                                ? 'selected' : '' }}>Tidak Sekolah</option>
                            <option value="SD" {{ old('pendidikan', $penduduk->pendidikan) == 'SD' ? 'selected' : ''
                                }}>SD</option>
                            <option value="SMP" {{ old('pendidikan', $penduduk->pendidikan) == 'SMP' ? 'selected' : ''
                                }}>SMP</option>
                            <option value="SMA" {{ old('pendidikan', $penduduk->pendidikan) == 'SMA' ? 'selected' : ''
                                }}>SMA</option>
                            <option value="D1" {{ old('pendidikan', $penduduk->pendidikan) == 'D1' ? 'selected' : ''
                                }}>D1</option>
                            <option value="D2" {{ old('pendidikan', $penduduk->pendidikan) == 'D2' ? 'selected' : ''
                                }}>D2</option>
                            <option value="D3" {{ old('pendidikan', $penduduk->pendidikan) == 'D3' ? 'selected' : ''
                                }}>D3</option>
                            <option value="S1" {{ old('pendidikan', $penduduk->pendidikan) == 'S1' ? 'selected' : ''
                                }}>S1</option>
                            <option value="S2" {{ old('pendidikan', $penduduk->pendidikan) == 'S2' ? 'selected' : ''
                                }}>S2</option>
                            <option value="S3" {{ old('pendidikan', $penduduk->pendidikan) == 'S3' ? 'selected' : ''
                                }}>S3</option>
                        </select>
                        @error('pendidikan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <select id="pekerjaan" name="pekerjaan"
                            ...
                            <option value="bekerja" {{ old('pekerjaan', $penduduk->pekerjaan) == 'bekerja' ? 'selected'
                                : '' }}>Bekerja</option>
                            <option value="tidak bekerja" {{ old('pekerjaan', $penduduk->pekerjaan) == 'tidak bekerja' ?
                                'selected' : '' }}>Tidak Bekerja</option>
                        </select>
                        @error('pekerjaan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
