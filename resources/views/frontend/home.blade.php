...
<section class="relative h-[90vh] flex items-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-6 text-white z-10">
        ...
        <p class="mt-4 max-w-2xl text-xl md:text-2xl opacity-90 leading-relaxed animate-fade-in-up animation-delay-200">
            Media informasi, transparansi, dan pelayanan publik berbasis digital untuk masyarakat {{ $identitas_desa->nama_desa ?? 'desa' }} yang lebih maju.
        </p>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-6">
            ...
            <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-emerald-100 transform hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-2">{{ $total_dusun }}</h3>
            ...
            <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-emerald-100 transform hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 class="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">{{ $total_rt_rw }}</h3>
                <p class="text-sm text-slate-600 font-medium">RT / RW</p>
                <p class="text-xs text-slate-400 mt-1">Unit lingkungan</p>
            </div>

            <div class="group bg-gradient-to-br from-emerald-500 to-teal-600 p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 text-white">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-14 h-14 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
...
<section id="layanan" class="max-w-7xl mx-auto px-6 py-24">
    ...
    <div class="grid md:grid-cols-4 gap-6">
        ...
        <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
            <div class="w-16 h-16 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all">
        ...
        <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
            <div class="w-16 h-16 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all">
        ...
        <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
            <div class="w-16 h-16 bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all">
                <span class="text-4xl">📜</span>
            </div>
        ...
        <div class="group bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 transform hover:-translate-y-2 transition-all duration-300 cursor-pointer">
            <div class="w-16 h-16 bg-gradient-to-br from-orange-100 to-red-100 rounded-2xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all">
                <span class="text-4xl">🗺️</span>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <p class="text-lg leading-relaxed text-slate-700">
                    {{ $identitas_desa->nama_desa ?? 'Desa Kembang Merta' }} merupakan desa yang menjunjung tinggi nilai-nilai
                ...
                <div class="flex gap-4 pt-4">
                    <a href="#" class="px-6 py-3 bg-emerald-600 text-white rounded-full font-semibold hover:bg-emerald-700 transition-colors shadow-lg hover:shadow-xl">
                        Selengkapnya
                    </a>
                    <a href="#" class="px-6 py-3 border-2 border-emerald-600 text-emerald-700 rounded-full font-semibold hover:bg-emerald-50 transition-colors">
                        Hubungi Kami
                    </a>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/50 transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-start gap-4">
                        <div class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/50 transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-start gap-4">
                        <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                            </svg>
                        </div>
                ...
                <div class="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/50 transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-start gap-4">
                        <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="max-w-7xl mx-auto px-6 py-24">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
        <div>
            <span class="inline-block bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-3">
                📰 Berita Terkini
            </span>
