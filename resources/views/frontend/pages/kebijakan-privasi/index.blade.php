...
<x-hero-section 
    ...
    subtitle="Komitmen kami dalam melindungi data pribadi dan privasi pengguna layanan digital desa."
    :breadcrumb="[
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 lg:p-12">
                    ...
                    <div id="kontak" class="scroll-mt-28">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="{{ route('kontak') }}" class="flex items-center gap-4 p-4 rounded-xl border border-gray-200 hover:border-emerald-500 hover:bg-emerald-50 transition group">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold">{{ config('app.email', 'admin@desa.go.id') }}</p>
                                </div>
                            </a>
                            ...
                            <div class="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold text-sm">Kec. {{ config('app.district') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
