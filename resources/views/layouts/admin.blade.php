        ...
        <aside
            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-3 mb-8 pb-6 border-b border-white/10">
                    <div
                        class="w-12 h-12 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center text-xl font-bold shadow-lg">
                ...
                <nav class="space-y-1">
                    ...
                    <!-- Info Desa -->
                    <div>
                        <button @click="infoDesa = !infoDesa"
                        ...
                        <div class="submenu mt-1 ml-4 space-y-1" :class="{ 'open': infoDesa }">
                            ...
                            <a href="/admin/kerjasama"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full bg-white/50"></span>
                                <span>Pendaftaran Kerjasama</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <!-- Kependudukan -->
                    <div>
                        <button @click="kependudukan = !kependudukan"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <div>
                        ...
                        <div class="submenu mt-1 ml-4 space-y-1" :class="{ 'open': statistik }">
                            ...
                            <a href="/admin/statistik/kelompok-rentan"
                                ...
                                <span class="w-1.5 h-1.5 rounded-full bg-white/50"></span>
                                <span>Laporan Kelompok Rentan</span>
                            </a>
                    ...
                    <!-- Kesehatan -->
                    <div>
                        <button @click="kesehatan = !kesehatan"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <!-- Kehadiran -->
                    <div>
                        <button @click="kehadiran = !kehadiran"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <!-- Layanan Surat -->
                    <div>
                        <button @click="layananSurat = !layananSurat"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <!-- Sekretariat -->
                    <div>
                        <button @click="sekretariat = !sekretariat"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <!-- Surat Dinas -->
                    <div>
                        <button @click="suratDinas = !suratDinas"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <div>
                        <button @click="bukuAdministrasi = !bukuAdministrasi"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                    ...
                    <!-- Pertanahan -->
                    <div>
                        <button @click="pertanahan = !pertanahan"
                            class="menu-header w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-semibold hover:bg-white/10"
                ...
                <div class="mt-8 pt-6 border-t border-white/10">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-medium transition-all duration-200 backdrop-blur-sm border border-white/20">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
