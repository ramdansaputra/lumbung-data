        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3">
                    @if(config('app.logo'))
                        <img src="{{ config('app.logo') }}" alt="Logo" class="h-12 w-12 object-contain drop-shadow-lg">
                    @else
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-sm text-slate-300 leading-snug block">
                                {{ isset($desa) ? ($desa->alamat_kantor ?? 'Alamat belum diatur') : 'Memuat data...' }}
                            </span>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ isset($desa) ? $desa->email_desa : '#' }}" class="text-sm text-slate-300 hover:text-white transition block">
                                {{ isset($desa) ? ($desa->email_desa ?? '-') : '-' }}
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm text-slate-300">{{ isset($desa) ? ($desa->telepon_desa ?? '-') : '-' }}</span>
                                @if(isset($desa->ponsel_desa))
                                    <span class="text-sm text-slate-300">{{ $desa->ponsel_desa }}</span>
                                @endif
                            </div>
                        </div>
                    </li>
        ...
        <div class="border-t border-emerald-900 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-400 text-sm text-center md:text-left">
                    &copy; {{ date('Y') }} 
                    <span class="text-white font-bold">{{ config('app.village_name') }}</span>. 
