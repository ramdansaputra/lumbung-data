        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div
                            class="font-bold text-xl bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                            {{ $identitas_desa->nama_desa ?? 'Desa Suka Maju' }}
                        </div>
                        <div class="text-xs text-slate-500">Kec. {{ $identitas_desa->kecamatan ?? 'Maju' }}, Kab. {{
                            $identitas_desa->kabupaten ?? 'Majubersama' }}</div>
                    </div>
                </div>
            ...
            <div id="mobileMenu" class="hidden lg:hidden mt-4 pb-4 border-t pt-4">
                <div class="flex flex-col gap-2">
                    <a href="{{ url('/') }}"
                        class="px-4 py-3 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-colors flex items-center gap-3">
                    ...
                    <a href="{{ url('/pemerintahan') }}"
                        class="px-4 py-3 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-colors flex items-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="curre.ntColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="grid md:grid-cols-4 gap-10">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center gap-3 mb-6">
                            <div
                                class="w-14 h-14 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center">
                            ...
                            <div>
                                <h3 class="font-bold text-2xl">{{ $identitas_desa->nama_desa ?? 'Desa Maju Bersama' }}
                                </h3>
                        ...
                        <div class="flex gap-3">
                            <a href="#"
                                class="w-10 h-10 bg-white/20 backdrop-blur-md rounded-lg flex items-center justify-center hover:bg-white/30 transition-all">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-emerald-100">
                            <li>
                                <a href="{{ url('/profil') }}"
                                    class="hover:text-white hover:translate-x-1 inline-block transition-all">→ Profil
                                    Desa</a>
                            </li>
                            <li>
                                <a href="{{ url('/pemerintahan') }}"
                                    class="hover:text-white hover:translate-x-1 inline-block transition-all">→
                                    Pemerintahan</a>
                            </li>
                            <li>
                                <a href="{{ url('/data-desa') }}"
                                    class="hover:text-white hover:translate-x-1 inline-block transition-all">→ Data
                                    Desa</a>
                            </li>
                            <li>
                                <a href="{{ url('/regulasi') }}"
                            ...
                            <li>
                                <a href="{{ url('/peta') }}"
                                    class="hover:text-white hover:translate-x-1 inline-block transition-all">→ Peta
                                    Desa</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="border-t border-emerald-600/30">
                <div class="max-w-7xl mx-auto px-6 py-6">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-emerald-100">
                        <p>© {{ date('Y') }} Pemerintah {{ $identitas_desa->nama_desa ?? 'Desa Suka Maju' }}. All rights
                            reserved.</p>
