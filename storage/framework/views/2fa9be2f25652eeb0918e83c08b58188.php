...
<?php $__env->startSection('description', 'Profil lengkap, Visi Misi, dan Struktur Pemerintahan Desa ' . ($profil['nama_desa'] ?? '')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => 'Profil Desa','subtitle' => 'Mengenal lebih dalam sejarah, visi, dan potensi yang dimiliki oleh desa kami.','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Profil Desa','subtitle' => 'Mengenal lebih dalam sejarah, visi, dan potensi yang dimiliki oleh desa kami.','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Profil Desa', 'url' => '#']
    ])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => $profil['nama_desa'] ?? 'Nama Desa','centered' => false,'badge' => 'Identitas Resmi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($profil['nama_desa'] ?? 'Nama Desa'),'centered' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'badge' => 'Identitas Resmi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="prose prose-emerald text-slate-600 leading-relaxed text-lg mb-10 text-justify">
                    <p><?php echo e($deskripsi ?? 'Deskripsi desa belum tersedia.'); ?></p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex items-start gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-medium"><?php echo e($profil['kode_desa'] ?? '-'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-medium"><?php echo e(($profil['kecamatan'] ?? '-') . ', ' . ($profil['kabupaten'] ?? '-')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            ...
                            <a href="mailto:<?php echo e($profil['email_desa'] ?? '#'); ?>" class="text-emerald-600 font-medium hover:underline"><?php echo e($profil['email_desa'] ?? '-'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 p-4 rounded-xl border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            ...
                            <a href="tel:<?php echo e($profil['telepon_desa'] ?? '#'); ?>" class="text-emerald-600 font-medium hover:underline"><?php echo e($profil['telepon_desa'] ?? '-'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:w-2/5 order-1 lg:order-2">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl group border-4 border-white">
                    <img src="<?php echo e($profil['gambar_kantor']); ?>" alt="Kantor Desa" class="w-full h-auto object-cover transform group-hover:scale-105 transition duration-700">
...
<section class="py-20 relative overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <?php if (isset($component)) { $__componentOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Visi & Misi','subtitle' => 'Arah pembangunan dan cita-cita luhur untuk kesejahteraan masyarakat.','badge' => 'Arah Pembangunan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Visi & Misi','subtitle' => 'Arah pembangunan dan cita-cita luhur untuk kesejahteraan masyarakat.','badge' => 'Arah Pembangunan']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78)): ?>
<?php $attributes = $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div class="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-emerald-500 hover:shadow-xl transition duration-300 relative overflow-hidden group">
                ...
                <p class="text-gray-700 text-lg font-medium leading-relaxed italic pl-4 border-l-4 border-emerald-200">
                    "<?php echo e($visiMisi['visi'] ?? 'Visi belum diatur'); ?>"
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-blue-500 hover:shadow-xl transition duration-300 relative overflow-hidden group">
                ...
                <ul class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $visiMisi['misi'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="flex items-start gap-4">
                            ...
                            <span class="text-gray-700 leading-relaxed"><?php echo e($item); ?></span>
                        </li>
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <?php if (isset($component)) { $__componentOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Struktur Pemerintahan','badge' => 'Kepala Desa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Struktur Pemerintahan','badge' => 'Kepala Desa']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78)): ?>
<?php $attributes = $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78; ?>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row mb-16">
            <div class="md:w-2/5 bg-gradient-to-br from-emerald-600 to-teal-800 relative flex items-center justify-center p-8 md:p-0">
                ...
                <div class="relative w-48 h-48 md:w-full md:h-full md:aspect-square overflow-hidden rounded-full md:rounded-none shadow-2xl border-4 border-white/20">
                    <img src="<?php echo e($kades->foto ?? 'https://via.placeholder.com/400x400'); ?>" alt="Kepala Desa" class="w-full h-full object-cover">
                </div>
            </div>
            ...
            <div class="md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                ...
                <h3 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($kades->nama ?? 'Nama Kepala Desa'); ?></h3>
                ...
                <div class="space-y-3 mb-8 border-t border-b border-gray-100 py-6 mt-4">
                    <div class="flex items-center gap-3 text-gray-600">
                        ...
                        <span class="font-mono">NIP: <?php echo e($kades->no_sk ?? '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>

        <?php if($perangkatLain->isNotEmpty()): ?>
            <?php if (isset($component)) { $__componentOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Perangkat Desa','centered' => true,'subtitle' => 'Jajaran perangkat desa yang siap melayani.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Perangkat Desa','centered' => true,'subtitle' => 'Jajaran perangkat desa yang siap melayani.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78)): ?>
<?php $attributes = $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78; ?>
...
<?php endif; ?>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <?php $__currentLoopData = $perangkatLain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perangkat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 text-center hover:shadow-md transition">
                        <img src="<?php echo e($perangkat['foto']); ?>" alt="<?php echo e($perangkat['nama']); ?>" class="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-2 border-emerald-100">
                        <h4 class="font-bold text-gray-900"><?php echo e($perangkat['nama']); ?></h4>
                        <p class="text-sm text-emerald-600 font-medium"><?php echo e($perangkat['jabatan']); ?></p>
                    </div>
...
<section class="py-20 bg-white border-t border-gray-100">
    <div class="container mx-auto px-4">
        <?php if (isset($component)) { $__componentOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Peta Lokasi','badge' => 'Lokasi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Peta Lokasi','badge' => 'Lokasi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78)): ?>
<?php $attributes = $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78; ?>
...
<?php endif; ?>
        ...
        <div class="bg-white p-2 rounded-3xl shadow-xl border border-gray-200 h-[400px] overflow-hidden">
            <iframe 
                src="<?php echo e($profil['link_peta']); ?>" 
                width="100%" 
                height="100%" 
                style="border:0;" 
                allowfullscreen="" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/profil/index.blade.php ENDPATH**/ ?>