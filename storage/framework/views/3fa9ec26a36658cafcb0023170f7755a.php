...
<?php $__env->startSection('title', 'Aktivasi Layanan Mandiri'); ?>
...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('aktivasi.check')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('login')); ?>" class="font-medium text-sm text-emerald-600 hover:text-emerald-500 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/auth/aktivasi-check.blade.php ENDPATH**/ ?>