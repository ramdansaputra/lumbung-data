...
<?php $__env->startSection('description', $artikel['excerpt']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => ''.e($artikel['title']).'','subtitle' => '','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($artikel['title']).'','subtitle' => '','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Berita', 'url' => route('artikel')],
        ['label' => $artikel['title'], 'url' => '#']
    ])]); ?>
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <!-- Featured Image -->
                <img src="<?php echo e($artikel['image']); ?>" alt="<?php echo e($artikel['title']); ?>" class="w-full rounded-lg shadow-lg mb-8 h-96 object-cover">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div class="flex items-center gap-2 text-gray-600">
                        ...
                        <span><?php echo e(\Carbon\Carbon::parse($artikel['date'])->isoFormat('D MMMM YYYY', locale: 'id')); ?></span>
                    </div>
                    ...
                    <div class="flex items-center gap-2 text-gray-600 ml-auto">
                        ...
                        <span><?php echo e($artikel['views']); ?> views</span>
                    </div>
                </div>

                <!-- Content -->
                <div class="prose prose-lg max-w-none mb-8">
                    <h1 class="text-3xl font-bold text-gray-900 mb-6"><?php echo e($artikel['title']); ?></h1>
                    <div class="text-gray-700 leading-relaxed whitespace-pre-wrap">
                        <?php echo e($artikel['content']); ?>
            ...
            <div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-8">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900"><?php echo e($artikel['author']); ?></p>
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $artikelTerkait; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $terkait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('artikel.show', $terkait['slug'])); ?>" class="block group">
                                <div class="rounded-lg overflow-hidden mb-2">
                                    <img src="<?php echo e($terkait['image']); ?>" alt="" class="w-full h-32 object-cover group-hover:scale-105 transition duration-300">
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/artikel/show.blade.php ENDPATH**/ ?>