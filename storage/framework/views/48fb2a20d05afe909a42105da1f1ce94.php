<?php $__env->startSection('title', 'Pengaturan Surat'); ?>
            ...
            <div class="p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php if(isset($templates) && $templates->count()): ?>
                            ...
                            <tr class="border-b border-slate-100 hover:bg-slate-50">
                                <td class="py-3 px-4 font-medium"><?php echo e($t->nama_template); ?></td>
                                <td class="py-3 px-4"><?php echo e($t->jenis_surat ?? '-'); ?></td>
                                <td class="py-3 px-4">
                                    <a href="<?php echo e(route('admin.layanan-surat.downloadTemplate', $t->id)); ?>"
                                        target="_blank" class="text-sm text-emerald-600 hover:underline"><?php echo e($t->original_name); ?></a>
                                </td>
                                <td class="py-3 px-4">
                                    <?php if($t->status): ?>
                                    <span
                                ...
                                <td class="py-3 px-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a href="<?php echo e(Storage::url($t->path)); ?>" target="_blank"
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('admin.layanan-surat.storeTemplate')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/admin/layanan-surat/pengaturan.blade.php ENDPATH**/ ?>