        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-lg text-gray-600"><?php echo e($artikel->nama); ?></p>
                </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-8">
            ...
            <div class="relative">
                <div class="aspect-[16/9] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    <img src="<?php echo e(asset('storage/artikel/' . $artikel->gambar)); ?>"
            ...
            <div class="p-8 lg:p-12">
                <!-- Article Title -->
                <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight"><?php echo e($artikel->nama); ?></h1>
                ...
                <div class="flex flex-wrap items-center gap-6 text-sm text-gray-500 mb-8 pb-8 border-b border-gray-100">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span>Dipublikasikan: <strong><?php echo e($artikel->publish_at ? \Carbon\Carbon::parse($artikel->publish_at)->format('d M Y, H:i') : 'N/A'); ?></strong></span>
                    </div>
                    <?php endif; ?>
                    <div class="flex items-center gap-2">
                        ...
                        <span>Diupdate: <strong><?php echo e($artikel->updated_at->diffForHumans()); ?></strong></span>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($artikel->publish_at ? 'Aktif' : 'Draft'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900">#<?php echo e($artikel->id); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e(rand(1, 5)); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/admin/artikel/show.blade.php ENDPATH**/ ?>