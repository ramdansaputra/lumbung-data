        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3">
                    <?php if($identitas_footer && $identitas_footer->logo_desa && file_exists(storage_path('app/public/logo-desa/'.$identitas_footer->logo_desa))): ?>
                        <img src="<?php echo e(asset('storage/logo-desa/'.$identitas_footer->logo_desa)); ?>" alt="Logo" class="h-12 w-12 object-contain drop-shadow-lg bg-white/10 rounded-lg p-1">
                    <?php else: ?>
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white tracking-tight leading-none">
                            <?php echo e($identitas_footer->nama_desa ?? config('app.name', 'Pemerintah Desa')); ?>

                        </h3>
                        <span class="text-xs text-emerald-400 font-bold uppercase tracking-widest">
                            Kec. <?php echo e($identitas_footer->kecamatan ?? 'Kecamatan'); ?>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('kontak')); ?>" class="flex items-center gap-2 text-slate-300 hover:text-emerald-400 hover:translate-x-1 transition-all duration-300 group">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-sm text-slate-300 leading-snug block">
                                <?php echo e($identitas_footer->alamat_kantor ?? 'Alamat belum diatur'); ?>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:<?php echo e($identitas_footer->email_desa ?? '#'); ?>" class="text-sm text-slate-300 hover:text-white transition block break-all">
                                <?php echo e($identitas_footer->email_desa ?? 'Belum diatur'); ?>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm text-slate-300"><?php echo e($identitas_footer->telepon_desa ?? '-'); ?></span>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="border-t border-emerald-800 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-400 text-sm text-center md:text-left">
                    ...
                    <span class="text-white font-bold"><?php echo e($identitas_footer->nama_desa ?? config('app.name')); ?></span>. 
                    Hak Cipta Dilindungi Undang-Undang.
                </p>
                
                <div class="flex flex-wrap justify-center gap-6 text-sm text-slate-400">
                    <a href="<?php echo e(route('kebijakan-privasi')); ?>" class="hover:text-white transition">Kebijakan Privasi</a>
                    <a href="<?php echo e(Route::has('syarat-ketentuan') ? route('syarat-ketentuan') : '#'); ?>" class="hover:text-white transition">Syarat & Ketentuan</a>
                    <a href="<?php echo e(route('faq')); ?>" class="hover:text-emerald-400 transition">Pertanyaan Umum (FAQ)</a>
                    <a href="<?php echo e(Route::has('peta-situs') ? route('peta-situs') : '#'); ?>" class="hover:text-white transition">Peta Situs</a>
                </div>
            </div>
        </div>
    </div>
</footer><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/layouts/footer.blade.php ENDPATH**/ ?>