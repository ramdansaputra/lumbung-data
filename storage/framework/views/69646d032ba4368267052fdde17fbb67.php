        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($artikels->total()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($artikels->whereNotNull('publish_at')->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($artikels->whereNull('publish_at')->count()); ?></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <img class="h-10 w-10 rounded-lg object-cover mr-3" src="<?php echo e(asset('storage/artikel/' . $artikel->gambar)); ?>" alt="Gambar Artikel">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e(Str::limit($artikel->nama, 50)); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit(strip_tags($artikel->deskripsi), 80)); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php if($artikel->publish_at): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($artikel->created_at ? $artikel->created_at->format('d M Y') : 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.artikel.show', $artikel)); ?>"
                                ...
                                <a href="<?php echo e(route('admin.artikel.edit', $artikel)); ?>"
                                ...
                                <form action="<?php echo e(route('admin.artikel.destroy', $artikel)); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/admin/artikel/index.blade.php ENDPATH**/ ?>