...
<?php $__env->startSection('description', 'Syarat dan ketentuan penggunaan layanan website Desa Serayu Larangan'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => 'Syarat & Ketentuan','subtitle' => 'Ketentuan penggunaan layanan digital dan akses informasi pada website resmi Pemerintah Desa.','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Syarat & Ketentuan','subtitle' => 'Ketentuan penggunaan layanan digital dan akses informasi pada website resmi Pemerintah Desa.','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Syarat & Ketentuan', 'url' => '#']
    ])]); ?>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-12 relative overflow-hidden">
                    ...
                    <section id="pendahuluan" class="mb-16 scroll-mt-32 relative z-10 observer-section">
                        ...
                        <div class="prose prose-emerald text-gray-600 leading-relaxed text-justify max-w-none">
                            <p class="mb-4">
                                Selamat datang di Website Resmi Pemerintah Desa <strong><?php echo e(config('app.village_name', 'Serayu Larangan')); ?></strong>. Halaman ini memuat Syarat dan Ketentuan yang mengatur akses serta penggunaan Anda terhadap seluruh layanan dan konten yang tersedia di website ini.
                            </p>
                            <p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/syarat-ketentuan/index.blade.php ENDPATH**/ ?>