...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($total_penduduk)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($laki_laki)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($perempuan)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($keluarga)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6">
            ...
            <form method="GET" action="<?php echo e(route('admin.penduduk')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="jenis_kelamin"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="Semua" <?php echo e(request('jenis_kelamin')=='Semua' ? 'selected' : ''); ?>>Semua
                            </option>
                    ...
                    <div>
                        ...
                        <select name="agama"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="Semua Agama" <?php echo e(request('agama')=='Semua Agama' ? 'selected' : ''); ?>>Semua
                                Agama</option>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($penduduk->firstItem() + $index); ?></td>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700">
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($p->jenis_kelamin == 'L' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800'); ?>">
                                <?php echo e($p->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($p->tempat_lahir); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($p->tanggal_lahir->format('d/m/Y')); ?></td>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700">
                            ...
                            ?>
                            <?php if($currentKeluarga): ?>
                                <?php echo e($currentKeluarga->no_kk); ?>

                                <br>
                                <small class="text-gray-500"><?php echo e(ucfirst(str_replace('_', ' ', $currentKeluarga->pivot->hubungan_keluarga))); ?></small>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700">
                            ...
                            ?>
                            <?php if($currentRumahTangga): ?>
                                <?php echo e($currentRumahTangga->no_rumah_tangga); ?>

                                <br>
                                <small class="text-gray-500"><?php echo e(ucfirst(str_replace('_', ' ', $currentRumahTangga->pivot->hubungan_rumah_tangga))); ?></small>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($p->golongan_darah ?? '-'); ?></td>
                        <td class="px-6 py-4 text-sm">
                            <div class="flex items-center gap-3">
                                <a href="<?php echo e(route('admin.penduduk.show', $p)); ?>"
                                    class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                                    Lihat
                                </a>
                                <a href="<?php echo e(route('admin.penduduk.edit', $p)); ?>"
                                    class="text-emerald-600 hover:text-emerald-800 font-medium transition-colors">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('admin.penduduk.confirm-destroy', $p)); ?>"
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div class="flex-1 flex justify-between sm:hidden">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e($penduduk->previousPageUrl()); ?>"
                    ...
                    <a href="<?php echo e($penduduk->nextPageUrl()); ?>"
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Menampilkan
                            <span class="font-medium"><?php echo e($penduduk->firstItem() ?? 0); ?></span>
                            sampai
                            <span class="font-medium"><?php echo e($penduduk->lastItem() ?? 0); ?></span>
                            dari
                            <span class="font-medium"><?php echo e($penduduk->total()); ?></span>
                            data
                        </p>
                    </div>
                    ...
                    <div>
                        <nav class="relative z-0 inline-flex rounded-lg shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            <?php $__currentLoopData = $penduduk->getUrlRange(1, $penduduk->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $penduduk->currentPage()): ?>
                            <span
...
<div id="modalImportPenduduk" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden z-50 transition-opacity">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full transform transition-all"
            ...
            <!-- Modal Body -->
            <form action="<?php echo e(route('admin.penduduk.import')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/admin/penduduk.blade.php ENDPATH**/ ?>