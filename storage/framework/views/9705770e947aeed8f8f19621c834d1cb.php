...
<?php $__env->startSection('title', 'Edit Identitas Desa'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.identitas-desa.index')); ?>"
    ...
    <!-- Form -->
    <form action="<?php echo e(route('admin.identitas-desa.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-4 flex justify-center">
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($desa->logo_desa &&
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-4">
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($desa->gambar_kantor &&
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama_desa" value="<?php echo e(old('nama_desa', $desa->nama_desa)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="kode_desa" value="<?php echo e(old('kode_desa', $desa->kode_desa)); ?>"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Kode BPS Desa</label>
                                <input type="text" name="kode_bps_desa"
                                    value="<?php echo e(old('kode_bps_desa', $desa->kode_bps_desa)); ?>"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Kode Pos</label>
                                <input type="text" name="kode_pos" value="<?php echo e(old('kode_pos', $desa->kode_pos)); ?>"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nip_kepala_desa"
                                    value="<?php echo e(old('nip_kepala_desa', $desa->nip_kepala_desa)); ?>"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <textarea name="alamat_kantor" rows="3"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all bg-gray-50 hover:bg-white resize-none"><?php echo e(old('alamat_kantor', $desa->alamat_kantor)); ?></textarea>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Email Desa</label>
                                    <input type="email" name="email_desa"
                                        value="<?php echo e(old('email_desa', $desa->email_desa)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="website_desa"
                                    value="<?php echo e(old('website_desa', $desa->website_desa)); ?>"
                                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all bg-gray-50 hover:bg-white"
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" name="kecamatan" value="<?php echo e(old('kecamatan', $desa->kecamatan)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="kode_kecamatan"
                                    value="<?php echo e(old('kode_kecamatan', $desa->kode_kecamatan)); ?>"
                                    class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-2">Nama Camat</label>
                                <input type="text" name="nama_camat" value="<?php echo e(old('nama_camat', $desa->nama_camat)); ?>"
                                    class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-2">NIP Camat</label>
                                <input type="text" name="nip_camat" value="<?php echo e(old('nip_camat', $desa->nip_camat)); ?>"
                                    class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" name="kabupaten" value="<?php echo e(old('kabupaten', $desa->kabupaten)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="kode_kabupaten"
                                    value="<?php echo e(old('kode_kabupaten', $desa->kode_kabupaten)); ?>"
                                    class="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all bg-gray-50 hover:bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div>
                                ...
                                <input type="text" name="provinsi" value="<?php echo e(old('provinsi', $desa->provinsi)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/identitas-desa/edit.blade.php ENDPATH**/ ?>