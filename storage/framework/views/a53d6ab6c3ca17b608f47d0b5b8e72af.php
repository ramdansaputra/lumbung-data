...
<?php $__env->startSection('description', 'Statistik dan data transparansi desa yang akuntabel'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => 'Data & Statistik Desa','subtitle' => 'Portal transparansi data kependudukan, pendidikan, sosial, dan anggaran desa yang akuntabel.','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data & Statistik Desa','subtitle' => 'Portal transparansi data kependudukan, pendidikan, sosial, dan anggaran desa yang akuntabel.','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Data Desa', 'url' => '#']
    ])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Demografi Penduduk','subtitle' => 'Gambaran umum populasi penduduk desa saat ini.','badge' => 'Statistik Utama']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Demografi Penduduk','subtitle' => 'Gambaran umum populasi penduduk desa saat ini.','badge' => 'Statistik Utama']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php $__currentLoopData = $statistikPenduduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-6">
                    <?php $__currentLoopData = $statistikPendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group">
                            <div class="flex justify-between items-end mb-2">
                                <span class="font-medium text-gray-700"><?php echo e($stat['label']); ?></span>
                                <span class="text-sm font-bold text-blue-600"><?php echo e($stat['value']); ?> (<?php echo e($stat['persen']); ?>%)</span>
                            </div>
                            <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                <div class="bg-blue-500 h-3 rounded-full transition-all duration-1000 ease-out group-hover:bg-blue-600" style="width: <?php echo e($stat['persen']); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-6">
                    <?php $__currentLoopData = $statistikPekerjaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pekerjaan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group">
                            <div class="flex justify-between items-end mb-2">
                                <span class="font-medium text-gray-700"><?php echo e($pekerjaan['label']); ?></span>
                                <span class="text-sm font-bold text-amber-600"><?php echo e($pekerjaan['value']); ?> (<?php echo e($pekerjaan['persen']); ?>%)</span>
                            </div>
                            <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                <div class="bg-amber-500 h-3 rounded-full transition-all duration-1000 ease-out group-hover:bg-amber-600" style="width: <?php echo e($pekerjaan['persen']); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="lg:col-span-2 bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $statistikAgama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gray-50 rounded-xl p-4 text-center hover:bg-emerald-50 transition border border-gray-100">
                            <h4 class="font-bold text-gray-800"><?php echo e($agama['label']); ?></h4>
                            <p class="text-2xl font-bold text-emerald-600 mt-2"><?php echo e($agama['value']); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($agama['persen']); ?>%</p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<section class="py-20 bg-emerald-700 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-12">
            <h2 class="text-3xl lg:text-4xl font-bold text-white mb-4">Transparansi Anggaran <?php echo e($anggaranDesa['tahun']); ?></h2>
        ...
        <div class="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="lg:w-1/3 text-center lg:text-left">
                    ...
                    <h3 class="text-4xl lg:text-5xl font-extrabold text-gray-900 mb-6"><?php echo e($anggaranDesa['total_anggaran']); ?></h3>
                ...
                <div class="lg:w-2/3 w-full space-y-6">
                    <?php $__currentLoopData = $anggaranDesa['sumber_dana']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative">
                            <div class="flex justify-between items-end mb-2">
                                <div class="flex items-center gap-3">
                                    <div class="w-3 h-3 rounded-full bg-emerald-500"></div>
                                    <span class="font-bold text-gray-800"><?php echo e($sumber['sumber']); ?></span>
                                </div>
                                <span class="font-mono font-bold text-gray-600"><?php echo e($sumber['nilai']); ?></span>
                            </div>
                            <div class="w-full bg-gray-100 rounded-full h-4 overflow-hidden shadow-inner">
                                <div class="bg-gradient-to-r from-emerald-400 to-teal-500 h-4 rounded-full" style="width: <?php echo e($sumber['persentase']); ?>%"></div>
                            </div>
                            <p class="text-right text-xs text-gray-400 mt-1"><?php echo e($sumber['persentase']); ?>% dari total anggaran</p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <?php if (isset($component)) { $__componentOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-title','data' => ['title' => 'Inventaris Aset Desa','subtitle' => 'Daftar kekayaan milik desa yang dikelola untuk kepentingan masyarakat.','badge' => 'Aset Desa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Inventaris Aset Desa','subtitle' => 'Daftar kekayaan milik desa yang dikelola untuk kepentingan masyarakat.','badge' => 'Aset Desa']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78)): ?>
<?php $attributes = $__attributesOriginal6a0a1523cc2edf33c83fe20a5d1f7f78; ?>
        ...
        <div class="overflow-x-auto bg-white rounded-2xl shadow-sm border border-gray-200">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    <?php $__empty_1 = true; $__currentLoopData = $asetDesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4 font-bold text-gray-900"><?php echo e($aset['nama']); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($aset['deskripsi']); ?></td>
                            <td class="px-6 py-4 text-center">
                                ...
                                <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($bgStatus); ?>">
                                    <?php echo e($aset['kondisi']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-center font-mono text-gray-500"><?php echo e($aset['tahun']); ?></td>
                            <td class="px-6 py-4 text-right font-bold text-gray-900"><?php echo e($aset['nilai']); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/data-desa/index.blade.php ENDPATH**/ ?>