...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('admin.keuangan.kas-desa.create')); ?>"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
        <form action="<?php echo e(route('admin.keuangan.kas-desa')); ?>" method="GET" class="flex gap-3">
            ...
            <a href="<?php echo e(route('admin.keuangan.kas-desa')); ?>"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $kasDesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                            <?php echo e($kasDesa->firstItem() + $index); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                            <?php echo e($kas->tahun->tahun ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">
                            Rp <?php echo e(number_format($kas->saldo_awal, 0, ',', '.')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-emerald-600">
                            Rp <?php echo e(number_format($kas->saldo_akhir, 0, ',', '.')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('admin.keuangan.kas-desa.edit', $kas->id)); ?>"
                                    class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition text-xs">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="<?php echo e(route('admin.keuangan.kas-desa.destroy', $kas->id)); ?>" 
                                    method="POST" 
        ...
        <!-- Pagination -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kasDesa->hasPages()): ?>
        <div class="px-6 py-4 border-t border-slate-200">
            <?php echo e($kasDesa->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/keuangan/kas-desa.blade.php ENDPATH**/ ?>