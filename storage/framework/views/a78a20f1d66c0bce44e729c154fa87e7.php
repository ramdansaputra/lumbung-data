...
<?php $__env->startSection('title', 'Peta Situs'); ?>
<?php $__env->startSection('description', 'Struktur navigasi dan peta situs website Desa Serayu Larangan'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => 'Peta Situs','subtitle' => 'Navigasi visual lengkap seluruh layanan dan informasi di website resmi Pemerintah Desa.','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Peta Situs','subtitle' => 'Navigasi visual lengkap seluruh layanan dan informasi di website resmi Pemerintah Desa.','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Peta Situs', 'url' => '#']
    ])]); ?>
...
<section class="py-20 bg-gray-50 overflow-hidden relative">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="flex justify-center mb-16">
            <a href="<?php echo e(route('home')); ?>" class="group relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border-t-4 border-emerald-500 p-6 w-full relative group hover:-translate-y-2 transition duration-300">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo e(route('profil')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-emerald-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('pemerintahan')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-emerald-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('wilayah')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-emerald-50 hover:shadow-sm transition group/item">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border-t-4 border-blue-500 p-6 w-full relative group hover:-translate-y-2 transition duration-300">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo e(route('data-desa')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-blue-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('berita')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-blue-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('kontak')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-blue-50 hover:shadow-sm transition group/item">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg border-t-4 border-amber-500 p-6 w-full relative group hover:-translate-y-2 transition duration-300">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo e(route('kebijakan-privasi')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-amber-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('syarat-ketentuan')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-gray-50 hover:bg-amber-50 hover:shadow-sm transition group/item">
                        ...
                        <a href="<?php echo e(route('setup')); ?>" class="flex items-center gap-4 p-3 rounded-xl bg-slate-800 hover:bg-slate-900 hover:shadow-md transition group/item text-white">
...
<section class="py-16 bg-white border-t border-gray-100">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="max-w-md mx-auto relative group">
            ...
            <form action="<?php echo e(route('berita')); ?>" method="GET" class="relative">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/peta-situs/index.blade.php ENDPATH**/ ?>