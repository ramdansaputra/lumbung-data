...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="<?php echo e(route('admin.rumah-tangga.create')); ?>"
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($total_rumah_tangga)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($rumah_tangga_aktif)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format(\App\Models\RumahTangga::sum('jumlah_anggota'))); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6">
            ...
            <form method="GET" action="<?php echo e(route('admin.rumah-tangga.index')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="tidak_aktif" <?php echo e(request('status')=='tidak_aktif' ? 'selected' : ''); ?>>Pindah</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="klasifikasi"
                            ...
                            <option value="miskin" <?php echo e(request('klasifikasi')=='miskin' ? 'selected' : ''); ?>>Miskin</option>
                            <option value="rentan" <?php echo e(request('klasifikasi')=='rentan' ? 'selected' : ''); ?>>Rentan</option>
                            <option value="mampu" <?php echo e(request('klasifikasi')=='mampu' ? 'selected' : ''); ?>>Mampu</option>
                        </select>
                    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $rumahTangga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rtg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($rumahTangga->firstItem() + $index); ?></td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($rtg->kode_rumah_tangga); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($rtg->kepala_rumah_tangga_name); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($rtg->alamat); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700">
                            RT <?php echo e($rtg->rt); ?> / RW <?php echo e($rtg->rw); ?> - <?php echo e($rtg->dusun); ?>

                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700 text-center"><?php echo e($rtg->anggota_count); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700">
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($rtg->status == 'aktif' ? 'bg-emerald-100 text-emerald-800' : 'bg-orange-100 text-orange-800'); ?>">
                                <?php echo e($rtg->status == 'aktif' ? 'Aktif' : 'Pindah'); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm">
                            <div class="flex items-center gap-3">
                                <a href="<?php echo e(route('admin.rumah-tangga.show', $rtg)); ?>"
                                    class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                                    Lihat
                                </a>
                                <a href="<?php echo e(route('admin.rumah-tangga.edit', $rtg)); ?>"
                                    class="text-emerald-600 hover:text-emerald-800 font-medium transition-colors">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('admin.rumah-tangga.confirm-destroy', $rtg)); ?>"
        ...
        <!-- Pagination -->
        <?php if($rumahTangga->hasPages()): ?>
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div class="flex-1 flex justify-between sm:hidden">
                    <?php if($rumahTangga->onFirstPage()): ?>
                    <span
                    ...
                    <?php else: ?>
                    <a href="<?php echo e($rumahTangga->previousPageUrl()); ?>"
                    ...
                    <?php if($rumahTangga->hasMorePages()): ?>
                    <a href="<?php echo e($rumahTangga->nextPageUrl()); ?>"
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Menampilkan
                            <span class="font-medium"><?php echo e($rumahTangga->firstItem() ?? 0); ?></span>
                            sampai
                            <span class="font-medium"><?php echo e($rumahTangga->lastItem() ?? 0); ?></span>
                            dari
                            <span class="font-medium"><?php echo e($rumahTangga->total()); ?></span>
                            data
                        </p>
                    </div>
                    ...
                    <div>
                        <nav class="relative z-0 inline-flex rounded-lg shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            <?php $__currentLoopData = $rumahTangga->getUrlRange(1, $rumahTangga->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $rumahTangga->currentPage()): ?>
                            <span
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/admin/rumah-tangga.blade.php ENDPATH**/ ?>