    ...
    <a href="/admin/penduduk" class="stat-card card-hover rounded-xl p-6 group">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h3 class="text-3xl font-bold text-slate-900 mt-2"><?php echo e(number_format($pendudukCount ?? 0)); ?></h3>
            </div>
            <div
    ...
    <a href="/admin/keluarga" class="stat-card card-hover rounded-xl p-6 group">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h3 class="text-3xl font-bold text-slate-900 mt-2"><?php echo e(number_format($keluargaCount ?? 0)); ?></h3>
            </div>
            <div
    ...
    <a href="/admin/rumah-tangga" class="stat-card card-hover rounded-xl p-6 group">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h3 class="text-3xl font-bold text-slate-900 mt-2"><?php echo e(number_format($rumahTanggaCount ?? 0)); ?></h3>
            </div>
            <div
    ...
    <a href="/admin/layanan-surat/cetak" class="stat-card card-hover rounded-xl p-6 group">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h3 class="text-3xl font-bold text-slate-900 mt-2"><?php echo e(number_format($suratCount ?? 0)); ?></h3>
            </div>
            <div
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 card-hover">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                <div class="info-row flex-col !border-none">
                    ...
                    <span class="info-value text-emerald-600 mt-1"><?php echo e(number_format($pendudukCount ?? 0)); ?></span>
                </div>
                <div class="info-row flex-col !border-none">
                    <span class="info-label">Total Keluarga</span>
                    <span class="info-value text-emerald-600 mt-1"><?php echo e(number_format($keluargaCount ?? 0)); ?></span>
                </div>
                <div class="info-row flex-col !border-none">
                    <span class="info-label">Rata-rata Jiwa/KK</span>
                    <span class="info-value text-emerald-600 mt-1"><?php echo e($keluargaCount > 0 ? number_format($pendudukCount
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 card-hover">
            ...
            <div class="space-y-0">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e(number_format($wilayahCount ?? 0)); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Pengguna Sistem</span>
                    <span class="info-value"><?php echo e(number_format($totalUsers ?? 0)); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Template Surat</span>
                    <span class="info-value"><?php echo e(number_format($suratCount ?? 0)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="gradient-box gradient-primary rounded-2xl p-8 text-white shadow-lg card-hover">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white bg-opacity-20 rounded-lg p-4 backdrop-blur-sm">
                    ...
                    <p class="text-white text-sm font-semibold mt-2"><?php echo e(now()->format('d M Y H:i')); ?></p>
                </div>
            </div>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8">
        ...
        <div class="space-y-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentPenduduk ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penduduk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="activity-item">
                <div class="activity-dot"></div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-slate-900 truncate"><?php echo e($penduduk->nama ?? 'N/A'); ?></p>
                    <p class="text-xs text-slate-500 mt-1"><?php echo e($penduduk->created_at ?
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>