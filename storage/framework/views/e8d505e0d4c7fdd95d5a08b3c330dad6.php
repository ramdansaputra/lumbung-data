...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-section','data' => ['title' => 'Kebijakan Privasi','subtitle' => 'Komitmen kami dalam melindungi data pribadi dan privasi pengguna layanan digital desa secara transparan dan aman.','breadcrumb' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kebijakan Privasi','subtitle' => 'Komitmen kami dalam melindungi data pribadi dan privasi pengguna layanan digital desa secara transparan dan aman.','breadcrumb' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Beranda', 'url' => route('home')],
        ['label' => 'Kebijakan Privasi', 'url' => '#']
    ])]); ?>
                        ...
                        <nav id="toc-menu" class="hidden lg:block bg-white max-h-[60vh] overflow-y-auto lg:max-h-none lg:overflow-visible">
                            ...
                            <div class="p-4 lg:p-6 border-t border-gray-100 bg-gray-50">
                                ...
                                <p class="text-sm font-bold text-gray-700 flex items-center gap-1">
                                    ...
                                    <?php echo e($lastUpdated ?? date('d M Y')); ?>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-12 relative overflow-hidden">
                    ...
                    <section id="pendahuluan" class="mb-16 scroll-mt-32 relative z-10 observer-section">
                        ...
                        <div class="prose prose-emerald text-gray-600 leading-relaxed text-justify max-w-none">
                            <p class="mb-4">
                                Selamat datang di Website Resmi Pemerintah Desa <strong><?php echo e(config('app.village_name', 'Serayu Larangan')); ?></strong>. Kami sangat menghargai privasi Anda dan berkomitmen penuh untuk melindungi data pribadi serta informasi sensitif yang Anda bagikan saat menggunakan layanan digital kami.
                            </p>
                            <p>
                    ...
                    <section id="kontak" class="scroll-mt-32 relative z-10 observer-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="<?php echo e(route('kontak')); ?>" class="flex items-center gap-4 p-4 rounded-xl border border-gray-200 hover:border-emerald-500 hover:bg-emerald-50 transition group bg-white">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold break-all"><?php echo e(config('app.email', 'admin@desa.go.id')); ?></p>
                                </div>
                            </a>
                            ...
                            <div class="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold">Kec. <?php echo e(config('app.district', 'Kecamatan')); ?></p>
                                </div>
                            </div>
                        </div>
                    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\lumbung-data\resources\views/frontend/pages/kebijakan-privasi/index.blade.php ENDPATH**/ ?>