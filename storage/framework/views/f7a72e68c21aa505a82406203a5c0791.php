...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="<?php echo e(route('admin.keluarga.create')); ?>"
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($total_keluarga)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($keluarga_aktif)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($keluarga_pindah)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6">
            ...
            <form method="GET" action="<?php echo e(route('admin.keluarga')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="klasifikasi_ekonomi"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">
                            <option value="" <?php echo e(request('klasifikasi_ekonomi') == '' ? 'selected' : ''); ?>>Semua Klasifikasi</option>
                            <option value="miskin" <?php echo e(request('klasifikasi_ekonomi') == 'miskin' ? 'selected' : ''); ?>>Miskin</option>
                            <option value="rentan" <?php echo e(request('klasifikasi_ekonomi') == 'rentan' ? 'selected' : ''); ?>>Rentan</option>
                            <option value="mampu" <?php echo e(request('klasifikasi_ekonomi') == 'mampu' ? 'selected' : ''); ?>>Mampu</option>
                        </select>
                    </div>
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="<?php echo e(route('admin.keluarga')); ?>"
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $keluarga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($keluarga->firstItem() + $index); ?></td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($kk->no_kk); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kk->getKepalaKeluarga()): ?>
                                <?php echo e($kk->getKepalaKeluarga()->nama); ?>

                            <?php else: ?>
                                Belum ditentukan
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($kk->alamat); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($kk->wilayah ? 'RT ' . $kk->wilayah->rt . ' / RW ' . $kk->wilayah->rw . ' - ' . $kk->wilayah->dusun : 'Tidak Ditemukan'); ?></td>

                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e(ucfirst($kk->klasifikasi_ekonomi ?? '-')); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo e($kk->getTotalAnggota()); ?></td>
                        <td class="px-6 py-4 text-sm">
                            <div class="flex items-center gap-3">
                                <a href="<?php echo e(route('admin.keluarga.show', $kk)); ?>"
                                    class="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                                    Lihat
                                </a>
                                <a href="<?php echo e(route('admin.keluarga.edit', $kk)); ?>"
                                    class="text-emerald-600 hover:text-emerald-800 font-medium transition-colors">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('admin.keluarga.confirm-destroy', $kk)); ?>"
        ...
        <!-- Pagination -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($keluarga->hasPages()): ?>
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div class="flex-1 flex justify-between sm:hidden">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($keluarga->onFirstPage()): ?>
                    ...
                    <?php else: ?>
                    <a href="<?php echo e($keluarga->previousPageUrl()); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($keluarga->hasMorePages()): ?>
                    <a href="<?php echo e($keluarga->nextPageUrl()); ?>"
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Menampilkan
                            <span class="font-medium"><?php echo e($keluarga->firstItem() ?? 0); ?></span>
                            sampai
                            <span class="font-medium"><?php echo e($keluarga->lastItem() ?? 0); ?></span>
                            dari
                            <span class="font-medium"><?php echo e($keluarga->total()); ?></span>
                            data
                        </p>
                    </div>
                    ...
                    <div>
                        <nav class="relative z-0 inline-flex rounded-lg shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $keluarga->getUrlRange(1, $keluarga->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page == $keluarga->currentPage()): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/keluarga.blade.php ENDPATH**/ ?>