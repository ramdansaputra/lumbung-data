...
<?php $__env->startSection('title', 'Identitas Desa'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.identitas-desa.edit')); ?>"
    ...
    <div
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($desa && $desa->gambar_kantor &&
        file_exists(storage_path('app/public/gambar-kantor/'.$desa->gambar_kantor))): ?>
        <div class="absolute inset-0 bg-cover bg-center opacity-20"
            style="background-image: url('<?php echo e(asset('storage/gambar-kantor/'.$desa->gambar_kantor)); ?>')"></div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="flex-shrink-0">
                    <div
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($desa && $desa->logo_desa &&
                        file_exists(storage_path('app/public/logo-desa/'.$desa->logo_desa))): ?>
                        <img src="<?php echo e(asset('storage/logo-desa/'.$desa->logo_desa)); ?>"
                ...
                <div class="flex-1 text-center md:text-left">
                    <h2 class="text-4xl font-bold text-white mb-2">
                        <?php echo e($desa->nama_desa ?? 'Nama Desa Belum Diatur'); ?>
                    ...
                    <div
                        ...
                        <span
                            ...
                            Kec. <?php echo e($desa->kecamatan ?? '-'); ?>

                        </span>
                        <span class="text-white/60">•</span>
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-lg">
                            Kab. <?php echo e($desa->kabupaten ?? '-'); ?>

                        </span>
                        <span class="text-white/60">•</span>
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-lg">
                            <?php echo e($desa->provinsi ?? '-'); ?>
                    ...
                    <div
                        ...
                        <span class="text-sm font-medium text-white">Kepala Desa: <span class="font-bold"><?php echo e($desa->kepala_desa ?? '-'); ?></span></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->nama_desa ?? '-'); ?></dd>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-2 h-2 rounded-full bg-emerald-500 mt-2"></div>
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->kode_desa ?? '-'); ?></dd>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-2 h-2 rounded-full bg-emerald-500 mt-2"></div>
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->kode_bps_desa ?? '-'); ?>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->kode_pos ?? '-'); ?></dd>
                            </div>
                        </div>
                    </dl>
                </div>
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->kepala_desa ?? '-'); ?>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <dd class="mt-1 text-sm font-semibold text-gray-900"><?php echo e($desa->nip_kepala_desa ?? '-'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div class="p-4 space-y-3">
                        <div>
                            ...
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->kecamatan ?? '-'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium text-gray-500">Kode</dt>
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->kode_kecamatan ?? '-'); ?>

                            </dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium text-gray-500">Camat</dt>
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->nama_camat ?? '-'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium text-gray-500">NIP Camat</dt>
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->nip_camat ?? '-'); ?></dd>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-4 space-y-3">
                        <div>
                            <dt class="text-xs font-medium text-gray-500">Nama</dt>
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->kabupaten ?? '-'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium text-gray-500">Kode</dt>
                            <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->kode_kabupaten ?? '-'); ?>
                ...
                <div
                    ...
                    <div class="p-4">
                        ...
                        <dd class="mt-0.5 text-sm font-semibold text-gray-900"><?php echo e($desa->provinsi ?? '-'); ?></dd>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <dd class="text-sm font-medium text-gray-900 break-words"><?php echo e($desa->alamat_kantor ?? '-'); ?>
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <dd class="text-sm font-medium text-gray-900 break-all"><?php echo e($desa->email_desa ?? '-'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($desa->telepon_desa ?? '-'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($desa->ponsel_desa ?? '-'); ?></dd>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <dd class="text-sm font-medium text-gray-900 break-all"><?php echo e($desa->website_desa ?? '-'); ?>
            ...
            <div
                ...
                <div class="p-4">
                    <img src="<?php echo e(asset('storage/gambar-kantor/'.$desa->gambar_kantor)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/identitas-desa/index.blade.php ENDPATH**/ ?>