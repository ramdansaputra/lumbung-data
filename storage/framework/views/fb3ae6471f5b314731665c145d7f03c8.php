...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 no-print">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-slate-600">Anggaran Pendapatan dan Belanja Desa - Tahun <?php echo e($tahun); ?></p>
            </div>
    ...
    <!-- Period Selection -->
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 no-print">
        <form method="GET" action="<?php echo e(route('admin.keuangan.laporan-apbdes')); ?>"
            ...
            <div>
                ...
                <select name="tahun"
                    ...
                    <option value="<?php echo e($year); ?>" <?php echo e(request('tahun', $tahun)==$year ? 'selected' : ''); ?>><?php echo e($year); ?>
            ...
            <div>
                ...
                <select name="periode"
                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    <option value="semua" <?php echo e(request('periode', $periode)=='semua' ? 'selected' : ''); ?>>Semua</option>
                    <option value="jan-jun" <?php echo e(request('periode', $periode)=='jan-jun' ? 'selected' : ''); ?>>Januari -
                        Juni</option>
                    <option value="jul-des" <?php echo e(request('periode', $periode)=='jul-des' ? 'selected' : ''); ?>>Juli -
                        Desember</option>
                </select>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 no-print">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            ...
            <div class="flex items-center text-xs text-slate-500">
                <span>Realisasi: Rp <?php echo e(number_format($realisasiPendapatan, 0, ',', '.')); ?></span>
            </div>
            <!-- Progress Bar -->
            <?php
            ...
            <div class="mt-3">
                <div class="flex justify-between text-xs mb-1">
                    ...
                    <span class="font-semibold text-emerald-600"><?php echo e($persenPendapatan); ?>%</span>
                </div>
                <div class="w-full bg-slate-200 rounded-full h-2">
                    <div class="bg-emerald-500 h-2 rounded-full transition-all"
                        style="width: <?php echo e(min($persenPendapatan, 100)); ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            ...
            <div class="flex items-center text-xs text-slate-500">
                <span>Realisasi: Rp <?php echo e(number_format($realisasiBelanja, 0, ',', '.')); ?></span>
            </div>
            <!-- Progress Bar -->
            <?php
            ...
            <div class="mt-3">
                <div class="flex justify-between text-xs mb-1">
                    <span class="text-slate-600">Progress</span>
                    <span class="font-semibold text-red-600"><?php echo e($persenBelanja); ?>%</span>
                </div>
                <div class="w-full bg-slate-200 rounded-full h-2">
                    <div class="bg-red-500 h-2 rounded-full transition-all"
                        style="width: <?php echo e(min($persenBelanja, 100)); ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between mb-4">
                <div
                    class="p-3 <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'bg-blue-100' : 'bg-amber-100'); ?> rounded-lg">
                    <i
                        class="fas fa-balance-scale text-2xl <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'text-blue-600' : 'text-amber-600'); ?>"></i>
                </div>
                <span
                    class="text-xs font-semibold px-2 py-1 <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'bg-blue-100 text-blue-800' : 'bg-amber-100 text-amber-800'); ?> rounded-full">
                    <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'Surplus' : 'Defisit'); ?>

                </span>
            </div>
            <h3 class="text-sm font-medium text-slate-600 mb-1">Surplus/Defisit Anggaran</h3>
            <p
                class="text-2xl font-bold <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'text-blue-600' : 'text-amber-600'); ?> mb-2">
                Rp <?php echo e(number_format(abs($totalPendapatan - $totalBelanja), 0, ',', '.')); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            ...
            <p class="text-2xl font-bold text-purple-600 mb-2">
                Rp <?php echo e(number_format($totalBelanja - $realisasiBelanja, 0, ',', '.')); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden" id="apbdes-report">
        ...
        <div class="bg-slate-50 px-6 py-4 border-b border-slate-200">
            <div class="text-center">
                ...
                <p class="text-sm text-slate-600 mt-1">Tahun Anggaran <?php echo e($tahun); ?></p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode !== 'semua'): ?>
                <p class="text-sm text-slate-600">
                    Periode: <?php echo e($periode === 'jan-jun' ? 'Januari - Juni' : 'Juli - Desember'); ?>
        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse border border-slate-300">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-slate-50">
                                <td class="border border-slate-300 px-4 py-2 text-sm">
                                    <?php echo e($item->kegiatanAnggaran->kode ?? '-'); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-2 text-sm">
                                    <?php echo e($item->kegiatanAnggaran->nama_kegiatan ?? 'N/A'); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-2 text-sm text-right font-medium">
                                    <?php echo e(number_format($item->anggaran, 0, ',', '.')); ?>

                                </td>
                                <td
                                    class="border border-slate-300 px-4 py-2 text-sm text-right font-medium text-emerald-600">
                                    <?php echo e(number_format($item->total_realisasi ?? 0, 0, ',', '.')); ?>
                                ...
                                <td class="border border-slate-300 px-4 py-2 text-sm text-center">
                                    ...
                                    <span
                                        ...
                                        <?php echo e($persen >= 80 ? 'bg-emerald-100 text-emerald-800' : ($persen >= 50 ? 'bg-blue-100 text-blue-800' : 'bg-amber-100 text-amber-800')); ?>">
                                        <?php echo e($persen); ?>%
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr class="bg-emerald-100 font-bold">
                                ...
                                <td class="border border-slate-300 px-4 py-3 text-sm text-right text-emerald-800">
                                    <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-3 text-sm text-right text-emerald-800">
                                    <?php echo e(number_format($realisasiPendapatan, 0, ',', '.')); ?>
                                ...
                                <td class="border border-slate-300 px-4 py-3 text-sm text-center">
                                    <span
                                        ...
                                        <?php echo e($totalPendapatan > 0 ? number_format($realisasiPendapatan / $totalPendapatan
                                        * 100, 1) : 0); ?>%
                                    </span>
                                </td>
                            </tr>
            ...
            <div class="mb-8">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse border border-slate-300">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $belanja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-slate-50">
                                <td class="border border-slate-300 px-4 py-2 text-sm">
                                    <?php echo e($item->kegiatanAnggaran->kode ?? '-'); ?>
                                ...
                                <td class="border border-slate-300 px-4 py-2 text-sm text-center">
                                    ...
                                    <span
                                        class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold
                                        <?php echo e($persen >= 80 ? 'bg-red-100 text-red-800' : ($persen >= 50 ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800')); ?>">
                                        <?php echo e($persen); ?>%
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr class="bg-red-100 font-bold">
                                ...
                                <td class="border border-slate-300 px-4 py-3 text-sm text-right text-red-800">
                                    <?php echo e(number_format($totalBelanja, 0, ',', '.')); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-3 text-sm text-right text-red-800">
                                    <?php echo e(number_format($realisasiBelanja, 0, ',', '.')); ?>

                                </td>
                                <td class="border border-slate-300 px-4 py-3 text-sm text-center">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-red-200 text-red-900">
                                        <?php echo e($totalBelanja > 0 ? number_format($realisasiBelanja / $totalBelanja * 100, 1)
                                        : 0); ?>%
                                    </span>
                                </td>
                            </tr>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="text-center p-5 bg-white rounded-xl border-2 border-emerald-200 shadow-sm">
                        ...
                        <div class="mt-2 pt-2 border-t border-emerald-200">
                            <p class="text-xs text-slate-500">
                                Realisasi: <span class="font-semibold text-emerald-600"><?php echo e($totalPendapatan > 0 ?
                    ...
                    <div class="text-center p-5 bg-white rounded-xl border-2 border-red-200 shadow-sm">
                        ...
                        <div class="mt-2 pt-2 border-t border-red-200">
                            <p class="text-xs text-slate-500">
                                Realisasi: <span class="font-semibold text-red-600"><?php echo e($totalBelanja > 0 ?
                    ...
                    <div
                        class="text-center p-5 bg-white rounded-xl border-2 <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'border-blue-200' : 'border-amber-200'); ?> shadow-sm">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'bg-blue-100' : 'bg-amber-100'); ?> rounded-full mb-3">
                            <i
                                class="fas fa-balance-scale text-xl <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'text-blue-600' : 'text-amber-600'); ?>"></i>
                        </div>
                        <p class="text-xs text-slate-600 mb-2 uppercase tracking-wide">Surplus/Defisit</p>
                        <p
                            class="text-2xl font-bold <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'text-blue-600' : 'text-amber-600'); ?> mb-1">
                            Rp <?php echo e(number_format(abs($totalPendapatan - $totalBelanja), 0, ',', '.')); ?>

                        </p>
                        <div
                            class="mt-2 pt-2 border-t <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'border-blue-200' : 'border-amber-200'); ?>">
                            <p
                                class="text-xs font-semibold <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'text-blue-600' : 'text-amber-600'); ?>">
                                <?php echo e(($totalPendapatan - $totalBelanja) >= 0 ? 'SURPLUS' : 'DEFISIT'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-white rounded-lg p-4 border border-slate-200">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-600">Sudah Terealisasi:</span>
                                <span class="font-semibold text-emerald-600">Rp <?php echo e(number_format($realisasiPendapatan,
                                    0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between pt-2 border-t border-slate-200">
                                <span class="text-slate-600">Sisa Anggaran:</span>
                                <span class="font-bold text-slate-800">Rp <?php echo e(number_format($totalPendapatan -
                    ...
                    <div class="bg-white rounded-lg p-4 border border-slate-200">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                <span class="text-slate-600">Total Anggaran:</span>
                                <span class="font-semibold">Rp <?php echo e(number_format($totalBelanja, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-600">Sudah Terealisasi:</span>
                                <span class="font-semibold text-red-600">Rp <?php echo e(number_format($realisasiBelanja, 0, ',',
                                    '.')); ?></span>
                            </div>
                            <div class="flex justify-between pt-2 border-t border-slate-200">
                                <span class="text-slate-600">Sisa Anggaran:</span>
                                <span class="font-bold text-slate-800">Rp <?php echo e(number_format($totalBelanja -
            ...
            <div class="mt-12 print-only hidden">
                <div class="grid grid-cols-2 gap-12">
                    ...
                    <div class="text-center">
                        <p class="mb-16">Purwokerto, <?php echo e(date('d F Y')); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/keuangan/laporan-apbdes.blade.php ENDPATH**/ ?>