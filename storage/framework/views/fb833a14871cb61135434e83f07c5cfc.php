<?php $__env->startSection('title', 'Data Pemantauan Kesehatan'); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e($data->total()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(\App\Models\Vaksin::where('tanggal_mulai', '>=', now()->startOfMonth())->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(\App\Models\Vaksin::where('status', 'aktif')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(\App\Models\Vaksin::where('status', 'selesai')->count()); ?></p>
                </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($data->firstItem() + $index); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($item->penduduk->nik ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($item->nama_pasien ?? $item->penduduk->nama ?? '-'); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($item->penduduk->jenis_kelamin == 'L' ? 'L' : 'P'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($item->penduduk->tanggal_lahir ? \Carbon\Carbon::parse($item->penduduk->tanggal_lahir)->age : '-'); ?> Tahun</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($item->jenis_pemantauan ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($item->frekuensi ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($item->petugas ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php elseif($item->status == 'dihentikan'): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($item->tanggal_mulai ? \Carbon\Carbon::parse($item->tanggal_mulai)->format('d M Y') : '-'); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LumbungData\resources\views/admin/kesehatan/vaksin.blade.php ENDPATH**/ ?>